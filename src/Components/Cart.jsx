...
function Cart() {
  ...
  var x = uid;
      ...
      useEffect(()=>{
        const addDataToCart = async (value) =>{
            const productDoc = doc(db,"products",value)
            const productdocSnap = await getDoc(productDoc);
            setCartItemData([...mydata,productdocSnap.data()])
            mydata.push(productdocSnap.data())
        }
        cartItems.map(addDataToCart);
      },[cartItems])
        ...
        <div className="cart_details">
          ...
          <div className="form_row">
            <div className="form_group cart_type">
              ...
              <label className="type master" title="Master" for="master">
              ...
              <label className="type visa" title="Visa" for="visa">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 47.834 47.834" style={{enableBackground:"new 0 0 47.834 47.834", xmlSpace:"preserve"}}>
                  <g>
                    <g>
              ...
              <label className="type paypal" title="PayPal" for="paypal">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 47.834 47.834" style={{enableBackground:"new 0 0 50.409 50.409",xmlSpace:"preserve"}}>
                  <g>
                    <g>
            ...
            <div className="form_group">
              ...
              <input type="text" className="input" id="card_number" name='card' min="16" max="16" placeholder="0000 0000 0000 0000" onkeypress="return checkDigit(event)" autocomplete="off" required />
            </div>
      
            <div className="form_group w_75">
              <label className="input_label">Ecpiry Date</label>
              <input type="text" className="input" id="card_date" placeholder="MM / YY" onkeypress="return checkDigit(event)" autocomplete="off" required />
            </div>
      
            <div className="form_group w_25">
              <label className="input_label">CVV</label>
              <input type="password" className="input" min="3" max="3" placeholder="***" onkeypress="return checkDigit(event)" autocomplete="off" required />
            </div>
